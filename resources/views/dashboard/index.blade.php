<x-app-layout>
    @if (Auth::user()->role == 'admin' || Auth::user()->role == 'petugas')
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {{-- Card --}}
            <x-dashboard.card title="Total users" :users="$users" icon="1" :route="route('users.index')" />
            <x-dashboard.card title="Transactions" :users="$transactions" icon="2" :route="route('transactions.index')" />
            <x-dashboard.card title="Cars" :users="$cars" icon="3" :route="route('cars.index')" />
            <x-dashboard.card title="Income" :users="$totalIncome" icon="4" :route="route('payments.index')" />
            {{-- End Card --}}
        </div>
                ...
                <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
                    ...
                    <div class="text-center">
                        ...
                        <h1
                            ...
                            <span>RENTAL MOBIL</span><br>
                            <span class="text-blue-500">INDONESIA</span>
                        </h1>
                    </div>
                    <!-- End Title -->
                    ...
                    <div class="hidden absolute top-2/4 end-0 transform -translate-y-2/4 translate-x-40 md:block lg:translate-x-80"
                        aria-hidden="true">
                        <svg class="w-72 h-auto" width="1115" height="636" viewBox="0 0 1115 636"
