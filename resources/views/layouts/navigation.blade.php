<nav x-data="{ open: false }" class="fixed w-full z-[60] bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class=" mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class=" space-x-8 my-px ms-3 flex">
                    <x-nav-link :href="route('dashboard')">
                        <h1 class="flex-shrink-0 text-2xl font-bold text-blue-600">RentalKu</h1>
                    </x-nav-link>
                </div>
